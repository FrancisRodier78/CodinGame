...
Grâce à votre aide, le détective Pikaptcha a une meilleure idée de l'endroit où il s'est fait emprisonné : c'est un labyrinthe spatio-déformé ! 
Pikaptcha sait que la sortie est invisible et qu'il va devoir cartographier la structure du labyrinthe pour pouvoir s'en sortir.
...
Votre objectif est d'écrire un programme qui retournera pour chaque case du labyrinthe le nombre de fois 
que Pikaptcha traversera la case en suivant un mur jusqu'à atteindre la case de départ.
...
Vous devez analyser le labyrinthe donné et le retourner avec une petite transformation : 
  pour chaque case vide, au lieu de 0, retournez le nombre de fois que Pikaptcha a traversé cette case pendant sa traversée du labyrinthe, en suivant un mur. 
  Pour chaque case mur, ne changez rien, retournez toujours #.
...
Attention : les tests fournis et les validateurs utilisés pour le calcul du score sont similaires 
mais différents (pas de points pour les solutions "hardcodées").

Vous pouvez soumettre autant de solutions que vous le souhaitez. 
Seule votre meilleure soumission par question sera utilisée pour le classement final.
-->
